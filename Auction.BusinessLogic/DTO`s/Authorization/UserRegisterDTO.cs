...
namespace Auction.BusinessLogic.DTOs.Authorization
{
    public class UserRegisterDTO
    {
        ...
        [MaxLength(50, ErrorMessage = "Surname must be less than 50 symbols")]
        ...
        [MaxLength(15, ErrorMessage = "Password length must be less than 15 symbols")]
