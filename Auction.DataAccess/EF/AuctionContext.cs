        ...
        public class DbInitializer : DropCreateDatabaseAlways<AuctionContext>
        {
            protected override void Seed(AuctionContext context)
            {
                ...
                var tradingLots = new List<TradingLot>()
                {
                    ...
                    new TradingLot(){ Name = "Lot2", Description = "Some shitty thing1", Img = "/", Price = 11.2, TradeDuration = 4,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot3", Description = "Some shitty thing1", Img = "/", Price = 12.2, TradeDuration = 4,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[0].Id, User = userProfiles[0]},

                    new TradingLot(){ Name = "Lot4", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[1].Id, Category = categories[1], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot5", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[1].Id, Category = categories[1], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot6", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[1].Id, Category = categories[1], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot7", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[1].Id, Category = categories[1], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot8", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[1].Id, Category = categories[1], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot9", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[1].Id, Category = categories[1], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot10", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[2].Id, Category = categories[2], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot11", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[2].Id, Category = categories[2], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot12", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[2].Id, Category = categories[2], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot13", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[2].Id, Category = categories[2], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot14", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[2].Id, Category = categories[2], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    ...
                    new TradingLot(){ Name = "Lot17", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[3].Id, Category = categories[3], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot18", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[3].Id, Category = categories[3], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot19", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[3].Id, Category = categories[3], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot20", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[3].Id, Category = categories[3], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot21", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[3].Id, Category = categories[3], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot22", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[3].Id, Category = categories[3], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot23", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[3].Id, Category = categories[3], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot24", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[4].Id, Category = categories[4], UserId = userProfiles[0].Id, User = userProfiles[0]},

                    new TradingLot(){ Name = "Lot25", Description = "Some shitty thing", Img = "/", Price = 600, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[5].Id, Category = categories[5], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot26", Description = "Some shitty thing", Img = "/", Price = 600, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[5].Id, Category = categories[5], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot27", Description = "Some shitty thing", Img = "/", Price = 600, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[5].Id, Category = categories[5], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot28", Description = "Some shitty thing", Img = "/", Price = 600, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot29", Description = "Some shitty thing", Img = "/", Price = 500, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot30", Description = "Some shitty thing", Img = "/", Price = 500, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Lot31", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[0].Id, User = userProfiles[0]},
