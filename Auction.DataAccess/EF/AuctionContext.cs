    ...
    public class AuctionContext : IdentityDbContext<AppUser>, IDataContext
    {
        ...
        public class DbInitializer : DropCreateDatabaseAlways<AuctionContext>
        {
            protected override void Seed(AuctionContext context)
            {
                ...
                {
                    new TradingLot(){ Name = "Garbage", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                    ...
                    new TradingLot(){ Name = "Garbage", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                    ...
                    new TradingLot(){ Name = "Garbage", Description = "Some shitty thing", Img = "/", Price = 5000, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[2].Id, Category = categories[2], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Garbage", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[2].Id, Category = categories[2], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Garbage", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[2].Id, Category = categories[2], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Garbage", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                    ...
                    new TradingLot(){ Name = "Garbage", Description = "Some shitty thing", Img = "/", Price = 600, TradeDuration = 3,
                    ...
                    new TradingLot(){ Name = "Garbage", Description = "Some shitty thing", Img = "/", Price = 600, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Garbage", Description = "Some shitty thing", Img = "/", Price = 500, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Garbage", Description = "Some shitty thing", Img = "/", Price = 500, TradeDuration = 3,
                        LotStatus = LotStatus.NotVerified, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[0].Id, User = userProfiles[0]},
                    new TradingLot(){ Name = "Garbage", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
