    ...
    public class AuctionContext : IdentityDbContext<AppUser>
    {
        ...
        public class DbInitializer : DropCreateDatabaseAlways<AuctionContext>
        {
            protected override void Seed(AuctionContext context)
            {
                ...
                {
                    new TradingLot(){ Name = "Lot1", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[2].Id, User = userProfiles[2]},
                    new TradingLot(){ Name = "Lot2", Description = "Some shitty thing", Img = "/", Price = 11.2, TradeDuration = 4,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[1], UserId = userProfiles[2].Id, User = userProfiles[2]},
                    new TradingLot(){ Name = "Lot3", Description = "Some shitty thing", Img = "/", Price = 12.2, TradeDuration = 4,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[2], UserId = userProfiles[2].Id, User = userProfiles[2]},
                    new TradingLot(){ Name = "Lot4", Description = "Some shitty thing", Img = "/", Price = 400, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[1].Id, Category = categories[3], UserId = userProfiles[2].Id, User = userProfiles[2]},

                    new TradingLot(){ Name = "Lot5", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[1].Id, Category = categories[4], UserId = userProfiles[3].Id, User = userProfiles[3]},
                    new TradingLot(){ Name = "Lot6", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[1].Id, Category = categories[5], UserId = userProfiles[3].Id, User = userProfiles[3]},
                    new TradingLot(){ Name = "Lot7", Description = "Some shitty thing", Img = "/", Price = 150, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[1].Id, Category = categories[6], UserId = userProfiles[3].Id, User = userProfiles[3]},
                    new TradingLot(){ Name = "Lot8", Description = "Some shitty thing", Img = "/", Price = 200, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[1].Id, Category = categories[7], UserId = userProfiles[3].Id, User = userProfiles[3]},

                    new TradingLot(){ Name = "Lot9", Description = "Some shitty thing", Img = "/", Price = 250, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[1].Id, Category = categories[8], UserId = userProfiles[4].Id, User = userProfiles[4]},
                    new TradingLot(){ Name = "Lot10", Description = "Some shitty thing", Img = "/", Price = 400, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[2].Id, Category = categories[9], UserId = userProfiles[4].Id, User = userProfiles[4]},
                    new TradingLot(){ Name = "Lot11", Description = "Some shitty thing", Img = "/", Price = 400, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[2].Id, Category = categories[10], UserId = userProfiles[4].Id, User = userProfiles[4]},
                    new TradingLot(){ Name = "Lot12", Description = "Some shitty thing", Img = "/", Price = 500, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[2].Id, Category = categories[10], UserId = userProfiles[4].Id, User = userProfiles[4]},

                    new TradingLot(){ Name = "Lot13", Description = "Some shitty thing", Img = "/", Price = 500, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[2].Id, Category = categories[10], UserId = userProfiles[5].Id, User = userProfiles[5]},
                    new TradingLot(){ Name = "Lot14", Description = "Some shitty thing", Img = "/", Price = 600, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[2].Id, Category = categories[10], UserId = userProfiles[5].Id, User = userProfiles[5]},
                    new TradingLot(){ Name = "Lot15", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[2].Id, Category = categories[10], UserId = userProfiles[5].Id, User = userProfiles[5]},

                    new TradingLot(){ Name = "Lot16", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[2].Id, Category = categories[1], UserId = userProfiles[6].Id, User = userProfiles[6]},
                    new TradingLot(){ Name = "Lot17", Description = "Some shitty thing", Img = "/", Price = 1100, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[3].Id, Category = categories[1], UserId = userProfiles[6].Id, User = userProfiles[6]},
                    new TradingLot(){ Name = "Lot18", Description = "Some shitty thing", Img = "/", Price = 300, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[3].Id, Category = categories[1], UserId = userProfiles[6].Id, User = userProfiles[6]},

                    new TradingLot(){ Name = "Lot19", Description = "Some shitty thing", Img = "/", Price = 400, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[3].Id, Category = categories[1], UserId = userProfiles[7].Id, User = userProfiles[7]},
                    new TradingLot(){ Name = "Lot20", Description = "Some shitty thing", Img = "/", Price = 500, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[3].Id, Category = categories[2], UserId = userProfiles[7].Id, User = userProfiles[7]},

                    new TradingLot(){ Name = "Lot21", Description = "Some shitty thing", Img = "/", Price = 600, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[3].Id, Category = categories[3], UserId = userProfiles[8].Id, User = userProfiles[8]},
                    new TradingLot(){ Name = "Lot22", Description = "Some shitty thing", Img = "/", Price = 700, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[3].Id, Category = categories[3], UserId = userProfiles[8].Id, User = userProfiles[8]},

                    new TradingLot(){ Name = "Lot23", Description = "Some shitty thing", Img = "/", Price = 800, TradeDuration = 3,
                        LotStatus = LotStatus.OnSale, CategoryId = categories[3].Id, Category = categories[3], UserId = userProfiles[9].Id, User = userProfiles[9]}
                    //new TradingLot(){ Name = "Lot24", Description = "Some shitty thing", Img = "/", Price = 900, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[4].Id, Category = categories[4], UserId = userProfiles[9].Id, User = userProfiles[9]},

                    //new TradingLot(){ Name = "Lot25", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[5].Id, Category = categories[5], UserId = userProfiles[10].Id, User = userProfiles[10]},
                    //new TradingLot(){ Name = "Lot26", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[5].Id, Category = categories[5], UserId = userProfiles[11].Id, User = userProfiles[11]},
                    //new TradingLot(){ Name = "Lot27", Description = "Some shitty thing", Img = "/", Price = 120, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[5].Id, Category = categories[5], UserId = userProfiles[11].Id, User = userProfiles[11]},

                    //new TradingLot(){ Name = "Lot28", Description = "Some shitty thing", Img = "/", Price = 150, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[12].Id, User = userProfiles[12]},
                    //new TradingLot(){ Name = "Lot29", Description = "Some shitty thing", Img = "/", Price = 300, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[12].Id, User = userProfiles[12]},

                    //new TradingLot(){ Name = "Lot30", Description = "Some shitty thing", Img = "/", Price = 200, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[3].Id, User = userProfiles[3]},
                    //new TradingLot(){ Name = "Lot31", Description = "Some shitty thing", Img = "/", Price = 300, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[3].Id, User = userProfiles[3]},
                    //new TradingLot(){ Name = "Lot32", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[3].Id, User = userProfiles[3]},
                    //new TradingLot(){ Name = "Lot33", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[3].Id, User = userProfiles[3]},

                    //new TradingLot(){ Name = "Lot34", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[4].Id, User = userProfiles[4]},

                    //new TradingLot(){ Name = "Lot35", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[5].Id, User = userProfiles[5]},

                    //new TradingLot(){ Name = "Lot36", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[6].Id, User = userProfiles[6]},
                    //new TradingLot(){ Name = "Lot37", Description = "Some shitty thing", Img = "/", Price = 100, TradeDuration = 3,
                    //    LotStatus = LotStatus.OnSale, CategoryId = categories[0].Id, Category = categories[0], UserId = userProfiles[6].Id, User = userProfiles[6]}
                };
